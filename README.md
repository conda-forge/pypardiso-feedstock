...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pypardiso-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13380&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pypardiso-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pypardiso` can be installed with:

```
conda install pypardiso
```

It is possible to list all of the versions of `pypardiso` available on your platform with:
